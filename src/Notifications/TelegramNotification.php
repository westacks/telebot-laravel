 ...
 *
 *
 * @method static self sendChatJoinRequestWebApp(...$parameters) Use this method to process a received chat join request query by showing a Mini App to the user before deciding the outcome. Returns True on success.
 *
