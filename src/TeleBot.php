 ...
 *
 *
 * @method static PromiseInterface|Message sendVideoNote(...$parameters) As of v.4.0, Telegram clients support rounded square MPEG4 videos of up to 1 minute long. Use this method to send video messages. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editEphemeralMessageText(...$parameters) Use this method to edit an ephemeral text message. Note that it is not guaranteed that the user will receive the message edit event, especially if they are offline. On success, True is returned.
 *
