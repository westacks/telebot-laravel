...
use WeStacks\TeleBot\TeleBot as CoreTeleBot;
 ...
 *
 *
 * @method static PromiseInterface|Update[] getUpdates(...$parameters) Use this method to receive incoming updates using long polling (wiki). Returns an Array of Update objects.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setWebhook(...$parameters) Use this method to specify a URL and receive incoming updates via an outgoing webhook. Whenever there is an update for the bot, we will send an HTTPS POST request to the specified URL, containing a JSON-serialized Update. In case of an unsuccessful request (a request with response HTTP status code different from 2XY), we will repeat the request and give up after a reasonable amount of attempts. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteWebhook(...$parameters) Use this method to remove webhook integration if you decide to switch back to getUpdates. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|WebhookInfo getWebhookInfo(...$parameters) Use this method to get current webhook status. Requires no parameters. On success, returns a WebhookInfo object. If the bot is using getUpdates, will return an object with the url field empty.
 *
 * {@see https://core.telegram.org/bots/api#getwebhookinfo}
 * @method static PromiseInterface|User getMe(...$parameters) A simple method for testing your bot's authentication token. Requires no parameters. Returns basic information about the bot in form of a User object.
 *
 * {@see https://core.telegram.org/bots/api#getme}
 * @method static PromiseInterface|true logOut(...$parameters) Use this method to log out from the cloud Bot API server before launching the bot locally. You must log out the bot before running it locally, otherwise there is no guarantee that the bot will receive updates. After a successful call, you can immediately log in on a local server, but will not be able to log in back to the cloud Bot API server for 10 minutes. Returns True on success. Requires no parameters.
 *
 * {@see https://core.telegram.org/bots/api#logout}
 * @method static PromiseInterface|true close(...$parameters) Use this method to close the bot instance before moving it from one local server to another. You need to delete the webhook before calling this method to ensure that the bot isn't launched again after server restart. The method will return error 429 in the first 10 minutes after the bot is launched. Returns True on success. Requires no parameters.
 *
 * {@see https://core.telegram.org/bots/api#close}
 * @method static PromiseInterface|Message sendMessage(...$parameters) Use this method to send text messages. On success, the sent Message is returned.
 *
 ...
 * - _EphemeralMessageParameters_ `$ephemeral_message_parameters` __Required: Optional__. A JSON-serialized object containing the parameters of the ephemeral message to send
 ...
 *
 *
 * @method static PromiseInterface|Message forwardMessage(...$parameters) Use this method to forward messages of any kind. Service messages and messages with protected content can't be forwarded. On success, the sent Message is returned.
 *
 ...
 * - _int|string_ `$from_chat_id` __Required: Yes__. Unique identifier for the chat where the original message was sent (or username of the target bot, supergroup or channel in the format @username)
 ...
 *
 *
 * @method static PromiseInterface|MessageId[] forwardMessages(...$parameters) Use this method to forward multiple messages of any kind. If some of the specified messages can't be found or forwarded, they are skipped. Service messages and messages with protected content can't be forwarded. Album grouping is kept for forwarded messages. On success, an Array of MessageId of the sent messages is returned.
 *
 ...
 * - _int|string_ `$from_chat_id` __Required: Yes__. Unique identifier for the chat where the original messages were sent (or username of the target bot, supergroup or channel in the format @username)
 ...
 *
 *
 * @method static PromiseInterface|Message sendPhoto(...$parameters) Use this method to send photos. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendLivePhoto(...$parameters) Use this method to send live photos. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendAudio(...$parameters) Use this method to send audio files, if you want Telegram clients to display them in the music player. Your audio must be in the .MP3 or .M4A format. On success, the sent Message is returned. Bots can currently send audio files of up to 50 MB in size, this limit may be changed in the future.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendDocument(...$parameters) Use this method to send general files. On success, the sent Message is returned. Bots can currently send files of any type of up to 50 MB in size, this limit may be changed in the future.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendVideo(...$parameters) Use this method to send video files, Telegram clients support MPEG4 videos (other formats may be sent as Document). On success, the sent Message is returned. Bots can currently send video files of up to 50 MB in size, this limit may be changed in the future.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendAnimation(...$parameters) Use this method to send animation files (GIF or H.264/MPEG-4 AVC video without sound). On success, the sent Message is returned. Bots can currently send animation files of up to 50 MB in size, this limit may be changed in the future.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendVoice(...$parameters) Use this method to send audio files, if you want Telegram clients to display the file as a playable voice message. For this to work, your audio must be in an .OGG file encoded with OPUS, or in .MP3 format, or in .M4A format (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendVideoNote(...$parameters) Use this method to send a rounded square MPEG4 video of up to 1 minute long. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendPaidMedia(...$parameters) Use this method to send paid media. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message[] sendMediaGroup(...$parameters) Use this method to send a group of photos, live photos, videos, documents or audios as an album. Documents and audio files can be only grouped in an album with messages of the same type. On success, an Array of Message objects that were sent is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendLocation(...$parameters) Use this method to send point on the map. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendVenue(...$parameters) Use this method to send information about a venue. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendContact(...$parameters) Use this method to send phone contacts. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendPoll(...$parameters) Use this method to send a native poll. On success, the sent Message is returned.
 *
 * {@see https://core.telegram.org/bots/api#sendpoll}
 *
 * Parameters:
 * - _string_ `$business_connection_id` __Required: Optional__. Unique identifier of the business connection on behalf of which the message will be sent
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target bot, supergroup or channel in the format @username. Polls can't be sent to channel direct messages chats.
 * - _int_ `$message_thread_id` __Required: Optional__. Unique identifier for the target message thread (topic) of a forum; for forum supergroups and private chats of bots with forum topic mode enabled only
 ...
 * - _InputPollMedia_ `$explanation_media` __Required: Optional__. Media added to the quiz explanation
 ...
 * - _InputPollMedia_ `$media` __Required: Optional__. Media added to the poll description
 * - _bool_ `$disable_notification` __Required: Optional__. Sends the message silently. Users will receive a notification with no sound.
 * - _bool_ `$protect_content` __Required: Optional__. Protects the contents of the sent message from forwarding and saving
 * - _bool_ `$allow_paid_broadcast` __Required: Optional__. Pass True to allow up to 1000 messages per second, ignoring broadcasting limits for a fee of 0.1 Telegram Stars per message. The relevant Stars will be withdrawn from the bot's balance.
 * - _string_ `$message_effect_id` __Required: Optional__. Unique identifier of the message effect to be added to the message; for private chats only
 ...
 *
 *
 * @method static PromiseInterface|Message sendChecklist(...$parameters) Use this method to send a checklist on behalf of a connected business account. On success, the sent Message is returned.
 *
 ...
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target bot in the format @username
 ...
 *
 *
 * @method static PromiseInterface|Message sendDice(...$parameters) Use this method to send an animated emoji that will display a random value. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true sendMessageDraft(...$parameters) Use this method to stream a partial message to a user while the message is being generated. Note that the streamed draft is ephemeral and acts as a temporary 30-second preview - once the output is finalized, you must call sendMessage with the complete message to persist it in the user's chat. Returns True on success.
 *
 ...
 * - _int_ `$draft_id` __Required: Yes__. Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. Otherwise, the draft is replaced without animation.
 ...
 * - _string_ `$parse_mode` __Required: Optional__. Mode for parsing entities in the message text. See formatting options for more details.
 * - _MessageEntity[]_ `$entities` __Required: Optional__. A JSON-serialized list of special entities that appear in message text, which can be specified instead of parse_mode
 * - _bool_ `$can_stop` __Required: Optional__. Pass True to show the user a button to stop further drafts. The bot will receive an Update “stopped_message_generation” if the user presses the button.
 * - _bool_ `$keep_on_stop` __Required: Optional__. Pass True to keep the draft in the chat when the button is pressed. The draft will still disappear after a short time or if the bot sends a message. To fully preserve the partial draft, the bot should send it as a new message.
 *
 *
 * @method static PromiseInterface|true sendChatAction(...$parameters) Use this method when you need to tell the user that something is happening on the bot's side. The status is set for 5 seconds or less (when a message arrives from your bot, Telegram clients clear its typing status). Returns True on success.
 *
 ...
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target bot or supergroup in the format @username. Channel chats and channel direct messages chats aren't supported.
 ...
 *
 *
 * @method static PromiseInterface|true setMessageReaction(...$parameters) Use this method to change the chosen reactions on a message. Service messages of some types can't be reacted to. Automatically forwarded messages from a channel to its discussion group have the same available reactions as messages in the channel. Bots can't use paid reactions. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|UserProfilePhotos getUserProfilePhotos(...$parameters) Use this method to get a list of profile pictures for a user. Returns a UserProfilePhotos object.
 *
 ...
 *
 *
 * @method static PromiseInterface|UserProfileAudios getUserProfileAudios(...$parameters) Use this method to get a list of profile audios for a user. Returns a UserProfileAudios object.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setUserEmojiStatus(...$parameters) Changes the emoji status for a given user that previously allowed the bot to manage their emoji status via the Mini App method requestEmojiStatusAccess. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true promoteChatMember(...$parameters) Use this method to promote or demote a user in a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Pass False for all boolean parameters to demote a user. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#promotechatmember}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target channel in the format @username
 * - _int_ `$user_id` __Required: Yes__. Unique identifier of the target user
 ...
 * - _bool_ `$can_send_welcome_messages` __Required: Optional__. Pass True if the administrator can manage chat welcome messages or directly send them in the case of bots
 *
 *
 * @method static PromiseInterface|true setChatAdministratorCustomTitle(...$parameters) Use this method to set a custom title for an administrator in a supergroup promoted by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setChatMemberTag(...$parameters) Use this method to set a tag for a regular member in a group or a supergroup. The bot must be an administrator in the chat for this to work and must have the can_manage_tags administrator right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true banChatSenderChat(...$parameters) Use this method to ban a channel chat in a supergroup or a channel. Until the chat is unbanned, the owner of the banned chat won't be able to send messages on behalf of any of their channels. The bot must be an administrator in the supergroup or channel for this to work and must have the appropriate administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true unbanChatSenderChat(...$parameters) Use this method to unban a previously banned channel chat in a supergroup or channel. The bot must be an administrator for this to work and must have the appropriate administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setChatPermissions(...$parameters) Use this method to set default chat permissions for all members. The bot must be an administrator in the group or a supergroup for this to work and must have the can_restrict_members administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|ChatInviteLink createChatInviteLink(...$parameters) Use this method to create an additional invite link for a chat. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. The link can be revoked using the method revokeChatInviteLink. Returns the new invite link as ChatInviteLink object.
 *
 ...
 *
 *
 * @method static PromiseInterface|ChatInviteLink createChatSubscriptionInviteLink(...$parameters) Use this method to create a subscription invite link for a channel chat. The bot must have the can_invite_users administrator rights. The link can be edited using the method editChatSubscriptionInviteLink or revoked using the method revokeChatInviteLink. Returns the new invite link as a ChatInviteLink object.
 *
 * {@see https://core.telegram.org/bots/api#createchatsubscriptioninvitelink}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target channel chat or username of the target channel in the format @username
 * - _string_ `$name` __Required: Optional__. Invite link name; 0-32 characters
 ...
 *
 *
 * @method static PromiseInterface|ChatInviteLink editChatSubscriptionInviteLink(...$parameters) Use this method to edit a subscription invite link created by the bot. The bot must have the can_invite_users administrator rights. Returns the edited invite link as a ChatInviteLink object.
 *
 ...
 *
 *
 * @method static PromiseInterface|ChatInviteLink revokeChatInviteLink(...$parameters) Use this method to revoke an invite link created by the bot. If the primary link is revoked, a new link is automatically generated. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns the revoked invite link as ChatInviteLink object.
 *
 * {@see https://core.telegram.org/bots/api#revokechatinvitelink}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier of the target chat or username of the target channel in the format @username
 * - _string_ `$invite_link` __Required: Yes__. The invite link to revoke
 *
 *
 * @method static PromiseInterface|true approveChatJoinRequest(...$parameters) Use this method to approve a chat join request. The bot must be an administrator in the chat for this to work and must have the can_invite_users administrator right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true declineChatJoinRequest(...$parameters) Use this method to decline a chat join request. The bot must be an administrator in the chat for this to work and must have the can_invite_users administrator right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true answerChatJoinRequestQuery(...$parameters) Use this method to process a received chat join request query. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setChatPhoto(...$parameters) Use this method to set a new profile photo for the chat. Photos can't be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteChatPhoto(...$parameters) Use this method to delete a chat photo. Photos can't be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setChatTitle(...$parameters) Use this method to change the title of a chat. Titles can't be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setChatDescription(...$parameters) Use this method to change the description of a group, a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true pinChatMessage(...$parameters) Use this method to add a message to the list of pinned messages in a chat. In private chats and channel direct messages chats, all non-service messages can be pinned. Conversely, the bot must be an administrator with the 'can_pin_messages' right or the 'can_edit_messages' right to pin messages in groups and channels respectively. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true unpinChatMessage(...$parameters) Use this method to remove a message from the list of pinned messages in a chat. In private chats and channel direct messages chats, all messages can be unpinned. Conversely, the bot must be an administrator with the 'can_pin_messages' right or the 'can_edit_messages' right to unpin messages in groups and channels respectively. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true unpinAllChatMessages(...$parameters) Use this method to clear the list of pinned messages in a chat. In private chats and channel direct messages chats, no additional rights are required to unpin all pinned messages. Conversely, the bot must be an administrator with the 'can_pin_messages' right or the 'can_edit_messages' right to unpin all pinned messages in groups and channels respectively. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true leaveChat(...$parameters) Use this method for your bot to leave a group, supergroup or channel. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#leavechat}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target supergroup or channel in the format @username. Channel direct messages chats aren't supported; leave the corresponding channel instead.
 *
 *
 * @method static PromiseInterface|ChatFullInfo getChat(...$parameters) Use this method to get up-to-date information about the chat. Returns a ChatFullInfo object on success.
 *
 * {@see https://core.telegram.org/bots/api#getchat}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target supergroup or channel in the format @username
 *
 *
 * @method static PromiseInterface|ChatMember[] getChatAdministrators(...$parameters) Use this method to get a list of administrators in a chat. Returns an Array of ChatMember objects.
 *
 ...
 *
 *
 * @method static PromiseInterface|int getChatMemberCount(...$parameters) Use this method to get the number of members in a chat. Returns Integer on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|ChatMember getChatMember(...$parameters) Use this method to get information about a member of a chat. The method is only guaranteed to work for other users if the bot is an administrator in the chat. Returns a ChatMember object on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message[] getUserPersonalChatMessages(...$parameters) Use this method to get the last messages from the personal chat (i.e., the chat currently added to their profile) of a given user. On success, an Array of Message objects is returned.
 *
 * {@see https://core.telegram.org/bots/api#getuserpersonalchatmessages}
 *
 * Parameters:
 * - _int_ `$user_id` __Required: Yes__. Unique identifier for the target user
 * - _int_ `$limit` __Required: Yes__. The maximum number of messages to return; 1-20
 *
 *
 * @method static PromiseInterface|true setChatStickerSet(...$parameters) Use this method to set a new group sticker set for a supergroup. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Use the field can_set_sticker_set optionally returned in getChat requests to check if the bot can use this method. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteChatStickerSet(...$parameters) Use this method to delete a group sticker set from a supergroup. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Use the field can_set_sticker_set optionally returned in getChat requests to check if the bot can use this method. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Sticker[] getForumTopicIconStickers(...$parameters) Use this method to get custom emoji stickers, which can be used as a forum topic icon by any user. Requires no parameters. Returns an Array of Sticker objects.
 *
 * {@see https://core.telegram.org/bots/api#getforumtopiciconstickers}
 * @method static PromiseInterface|ForumTopic createForumTopic(...$parameters) Use this method to create a topic in a forum supergroup chat or a private chat with a user. In the case of a supergroup chat the bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator right. Returns information about the created topic as a ForumTopic object.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editForumTopic(...$parameters) Use this method to edit name and icon of a topic in a forum supergroup chat or a private chat with a user. In the case of a supergroup chat the bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true closeForumTopic(...$parameters) Use this method to close an open topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true reopenForumTopic(...$parameters) Use this method to reopen a closed topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteForumTopic(...$parameters) Use this method to delete a forum topic along with all its messages in a forum supergroup chat or a private chat with a user. In the case of a supergroup chat the bot must be an administrator in the chat for this to work and must have the can_delete_messages administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true unpinAllForumTopicMessages(...$parameters) Use this method to clear the list of pinned messages in a forum topic in a forum supergroup chat or a private chat with a user. In the case of a supergroup chat the bot must be an administrator in the chat for this to work and must have the can_pin_messages administrator right in the supergroup. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editGeneralForumTopic(...$parameters) Use this method to edit the name of the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true closeGeneralForumTopic(...$parameters) Use this method to close an open 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true reopenGeneralForumTopic(...$parameters) Use this method to reopen a closed 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. The topic will be automatically unhidden if it was hidden. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true hideGeneralForumTopic(...$parameters) Use this method to hide the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. The topic will be automatically closed if it was open. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true unhideGeneralForumTopic(...$parameters) Use this method to unhide the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true answerCallbackQuery(...$parameters) Use this method to send answers to callback queries sent from inline keyboards. The answer will be displayed to the user as a notification at the top of the chat screen or as an alert. On success, True is returned.
 *
 ...
 * - _int_ `$cache_time` __Required: Optional__. The maximum amount of time in seconds that the result of the callback query may be cached client-side. Defaults to 0.
 *
 *
 * @method static PromiseInterface|SentGuestMessage answerGuestQuery(...$parameters) Use this method to reply to a received guest message. On success, a SentGuestMessage object is returned.
 *
 * {@see https://core.telegram.org/bots/api#answerguestquery}
 *
 * Parameters:
 * - _string_ `$guest_query_id` __Required: Yes__. Unique identifier for the query to be answered
 * - _InlineQueryResult_ `$result` __Required: Yes__. A JSON-serialized object describing the message to be sent
 *
 *
 * @method static PromiseInterface|UserChatBoosts getUserChatBoosts(...$parameters) Use this method to get the list of boosts added to a chat by a user. Requires administrator rights in the chat. Returns a UserChatBoosts object.
 *
 * {@see https://core.telegram.org/bots/api#getuserchatboosts}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the chat or username of the channel in the format @username
 * - _int_ `$user_id` __Required: Yes__. Unique identifier of the target user
 *
 *
 * @method static PromiseInterface|BusinessConnection getBusinessConnection(...$parameters) Use this method to get information about the connection of the bot with a business account. Returns a BusinessConnection object on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|string getManagedBotToken(...$parameters) Use this method to get the token of a managed bot. Returns the token as String on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|string replaceManagedBotToken(...$parameters) Use this method to revoke the current token of a managed bot and generate a new one. Returns the new token as String on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|BotAccessSettings getManagedBotAccessSettings(...$parameters) Use this method to get the access settings of a managed bot. Returns a BotAccessSettings object on success.
 *
 * {@see https://core.telegram.org/bots/api#getmanagedbotaccesssettings}
 *
 * Parameters:
 * - _int_ `$user_id` __Required: Yes__. User identifier of the managed bot whose access settings will be returned
 *
 *
 * @method static PromiseInterface|true setManagedBotAccessSettings(...$parameters) Use this method to change the access settings of a managed bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setMyCommands(...$parameters) Use this method to change the list of the bot's commands. See this manual for more details about bot commands. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteMyCommands(...$parameters) Use this method to delete the list of the bot's commands for the given scope and user language. After deletion, higher level commands will be shown to affected users. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|BotCommand[] getMyCommands(...$parameters) Use this method to get the current list of the bot's commands for the given scope and user language. Returns an Array of BotCommand objects. If commands aren't set, an empty list is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setMyName(...$parameters) Use this method to change the bot's name. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|BotName getMyName(...$parameters) Use this method to get the current bot name for the given user language. Returns BotName on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setMyDescription(...$parameters) Use this method to change the bot's description, which is shown in the chat with the bot if the chat is empty. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|BotDescription getMyDescription(...$parameters) Use this method to get the current bot description for the given user language. Returns BotDescription on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setMyShortDescription(...$parameters) Use this method to change the bot's short description, which is shown on the bot's profile page and is sent together with the link when users share the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|BotShortDescription getMyShortDescription(...$parameters) Use this method to get the current bot short description for the given user language. Returns BotShortDescription on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setMyProfilePhoto(...$parameters) Changes the profile photo of the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true removeMyProfilePhoto(...$parameters) Removes the profile photo of the bot. Requires no parameters. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#removemyprofilephoto}
 * @method static PromiseInterface|true setChatMenuButton(...$parameters) Use this method to change the bot's menu button in a private chat, or the default menu button. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#setchatmenubutton}
 *
 * Parameters:
 * - _int_ `$chat_id` __Required: Optional__. Unique identifier for the target private chat. If not specified, the bot's default menu button will be changed.
 ...
 *
 *
 * @method static PromiseInterface|MenuButton getChatMenuButton(...$parameters) Use this method to get the current value of the bot's menu button in a private chat, or the default menu button. Returns MenuButton on success.
 *
 * {@see https://core.telegram.org/bots/api#getchatmenubutton}
 *
 * Parameters:
 * - _int_ `$chat_id` __Required: Optional__. Unique identifier for the target private chat. If not specified, the bot's default menu button will be returned.
 *
 *
 * @method static PromiseInterface|true setMyDefaultAdministratorRights(...$parameters) Use this method to change the default administrator rights requested by the bot when it's added as an administrator to groups or channels. These rights will be suggested to users, but they are free to modify the list before adding the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|ChatAdministratorRights getMyDefaultAdministratorRights(...$parameters) Use this method to get the current default administrator rights of the bot. Returns ChatAdministratorRights on success.
 *
 ...
 *
 *
 * @method static PromiseInterface getAvailableGifts(...$parameters) Returns the list of gifts that can be sent by the bot to users and channel chats. Requires no parameters. Returns a Gifts object.
 *
 * {@see https://core.telegram.org/bots/api#getavailablegifts}
 * @method static PromiseInterface|true sendGift(...$parameters) Sends a gift to the given user or channel chat. The gift can't be converted to Telegram Stars by the receiver. Returns True on success.
 *
 ...
 * - _int|string_ `$chat_id` __Required: Optional__. Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @username) that will receive the gift.
 ...
 *
 *
 * @method static PromiseInterface|true giftPremiumSubscription(...$parameters) Gifts a Telegram Premium subscription to the given user. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true verifyUser(...$parameters) Verifies a user on behalf of the organization which is represented by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true verifyChat(...$parameters) Verifies a chat on behalf of the organization which is represented by the bot. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#verifychat}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target bot, supergroup or channel in the format @username. Channel direct messages chats can't be verified.
 * - _string_ `$custom_description` __Required: Optional__. Custom description for the verification; 0-70 characters. Must be empty if the organization isn't allowed to provide a custom verification description.
 *
 *
 * @method static PromiseInterface|true removeUserVerification(...$parameters) Removes verification from a user who is currently verified on behalf of the organization represented by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true removeChatVerification(...$parameters) Removes verification from a chat that is currently verified on behalf of the organization represented by the bot. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#removechatverification}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target bot or channel in the format @username
 *
 *
 * @method static PromiseInterface|true readBusinessMessage(...$parameters) Marks incoming message as read on behalf of a business account. Requires the can_read_messages business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteBusinessMessages(...$parameters) Delete messages on behalf of a business account. Requires the can_delete_sent_messages business bot right to delete messages sent by the bot itself, or the can_delete_all_messages business bot right to delete any message. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setBusinessAccountName(...$parameters) Changes the first and last name of a managed business account. Requires the can_change_name business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setBusinessAccountUsername(...$parameters) Changes the username of a managed business account. Requires the can_change_username business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setBusinessAccountBio(...$parameters) Changes the bio of a managed business account. Requires the can_change_bio business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setBusinessAccountProfilePhoto(...$parameters) Changes the profile photo of a managed business account. Requires the can_edit_profile_photo business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true removeBusinessAccountProfilePhoto(...$parameters) Removes the current profile photo of a managed business account. Requires the can_edit_profile_photo business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setBusinessAccountGiftSettings(...$parameters) Changes the privacy settings pertaining to incoming gifts in a managed business account. Requires the can_change_gift_settings business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Telegram|Stars getBusinessAccountStarBalance(...$parameters) Returns the amount of Telegram Stars owned by a managed business account. Requires the can_view_gifts_and_stars business bot right. Returns StarAmount on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true transferBusinessAccountStars(...$parameters) Transfers Telegram Stars from the business account balance to the bot's balance. Requires the can_transfer_stars business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface getBusinessAccountGifts(...$parameters) Returns the gifts received and owned by a managed business account. Requires the can_view_gifts_and_stars business bot right. Returns OwnedGifts on success.
 *
 ...
 *
 *
 * @method static PromiseInterface getUserGifts(...$parameters) Returns the gifts owned and hosted by a user. Returns OwnedGifts on success.
 *
 ...
 *
 *
 * @method static PromiseInterface getChatGifts(...$parameters) Returns the gifts owned by a chat. Returns OwnedGifts on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true convertGiftToStars(...$parameters) Converts a given regular gift to Telegram Stars. Requires the can_convert_gifts_to_stars business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true upgradeGift(...$parameters) Upgrades a given regular gift to a unique gift. Requires the can_transfer_and_upgrade_gifts business bot right. Additionally requires the can_transfer_stars business bot right if the upgrade is paid. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true transferGift(...$parameters) Transfers an owned unique gift to another user. Requires the can_transfer_and_upgrade_gifts business bot right. Requires can_transfer_stars business bot right if the transfer is paid. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Story postStory(...$parameters) Posts a story on behalf of a managed business account. Requires the can_manage_stories business bot right. Returns Story on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Story repostStory(...$parameters) Reposts a story on behalf of a business account from another business account. Both business accounts must be managed by the same bot, and the story on the source account must have been posted (or reposted) by the bot. Requires the can_manage_stories business bot right for both business accounts. Returns Story on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Story editStory(...$parameters) Edits a story previously posted by the bot on behalf of a managed business account. Requires the can_manage_stories business bot right. Returns Story on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteStory(...$parameters) Deletes a story previously posted by the bot on behalf of a managed business account. Requires the can_manage_stories business bot right. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|SentWebAppMessage answerWebAppQuery(...$parameters) Use this method to set the result of an interaction with a Web App and send a corresponding message on behalf of the user to the chat from which the query originated. On success, a SentWebAppMessage object is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|PreparedInlineMessage savePreparedInlineMessage(...$parameters) Stores a message that can be sent by a user of a Mini App. Returns a PreparedInlineMessage object.
 *
 ...
 *
 *
 * @method static PromiseInterface|PreparedKeyboardButton savePreparedKeyboardButton(...$parameters) Stores a keyboard button that can be used by a user within a Mini App. Returns a PreparedKeyboardButton object.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message|true editMessageText(...$parameters) Use this method to edit text, rich and game messages. On success, if the edited message is not an inline message, the edited Message is returned, otherwise True is returned. Note that business messages that were not sent by the bot and do not contain an inline keyboard can only be edited within 48 hours from the time they were sent.
 *
 ...
 * - _MessageEntity[]_ `$entities` __Required: Optional__. A JSON-serialized list of special entities that appear in message text, which can be specified instead of parse_mode
 * - _LinkPreviewOptions_ `$link_preview_options` __Required: Optional__. Link preview generation options for the message
 * - _InputRichMessage_ `$rich_message` __Required: Optional__. New rich content of the message; required if text isn't specified. Direct upload of new files and explicit upload of files by a URL isn't supported when an inline message is edited.
 * - _InlineKeyboardMarkup_ `$reply_markup` __Required: Optional__. A JSON-serialized object for an inline keyboard
 *
 *
 * @method static PromiseInterface|Message|true editMessageCaption(...$parameters) Use this method to edit captions of messages. On success, if the edited message is not an inline message, the edited Message is returned, otherwise True is returned. Note that business messages that were not sent by the bot and do not contain an inline keyboard can only be edited within 48 hours from the time they were sent.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message|true editMessageLiveLocation(...$parameters) Use this method to edit live location messages. A location can be edited until its live_period expires or editing is explicitly disabled by a call to stopMessageLiveLocation. On success, if the edited message is not an inline message, the edited Message is returned, otherwise True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message|true stopMessageLiveLocation(...$parameters) Use this method to stop updating a live location message before live_period expires. On success, if the message is not an inline message, the edited Message is returned, otherwise True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message editMessageChecklist(...$parameters) Use this method to edit a checklist on behalf of a connected business account. On success, the edited Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Poll stopPoll(...$parameters) Use this method to stop a poll which was sent by the bot. On success, the stopped Poll is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editEphemeralMessageText(...$parameters) Use this method to edit an ephemeral text or rich message. Note that it is not guaranteed that the user will receive the message edit event, especially if they are offline. On success, True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editEphemeralMessageMedia(...$parameters) Use this method to edit the media of an ephemeral message. Note that it is not guaranteed that the user will receive the message edit event, especially if they are offline. On success, True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editEphemeralMessageCaption(...$parameters) Use this method to edit the caption of an ephemeral message. Note that it is not guaranteed that the user will receive the message edit event, especially if they are offline. On success, True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editEphemeralMessageReplyMarkup(...$parameters) Use this method to edit only the reply markup of an ephemeral message. Note that it is not guaranteed that the user will receive the message edit event, especially if they are offline. On success, True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true approveSuggestedPost(...$parameters) Use this method to approve a suggested post in a direct messages chat. The bot must have the 'can_post_messages' administrator right in the corresponding channel chat. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#approvesuggestedpost}
 *
 * Parameters:
 * - _int_ `$chat_id` __Required: Yes__. Unique identifier for the target direct messages chat
 * - _int_ `$message_id` __Required: Yes__. Identifier of a suggested post message to approve
 * - _int_ `$send_date` __Required: Optional__. Point in time (Unix timestamp) when the post is expected to be published; omit if the date has already been specified when the suggested post was created. If specified, then the date must be not more than 2678400 seconds (30 days) in the future.
 *
 *
 * @method static PromiseInterface|true declineSuggestedPost(...$parameters) Use this method to decline a suggested post in a direct messages chat. The bot must have the 'can_manage_direct_messages' administrator right in the corresponding channel chat. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#declinesuggestedpost}
 *
 * Parameters:
 * - _int_ `$chat_id` __Required: Yes__. Unique identifier for the target direct messages chat
 * - _int_ `$message_id` __Required: Yes__. Identifier of a suggested post message to decline
 * - _string_ `$comment` __Required: Optional__. Comment for the creator of the suggested post; 0-128 characters
 *
 *
 * @method static PromiseInterface|true deleteMessage(...$parameters) Use this method to delete a message, including service messages, with the following limitations:- A message can only be deleted if it was sent less than 48 hours ago.- Service messages about a supergroup, channel, or forum topic creation can't be deleted.- A dice message in a private chat can only be deleted if it was sent more than 24 hours ago.- Bots can delete outgoing messages in private chats, groups, and supergroups.- Bots can delete incoming messages in private chats.- Bots granted can_post_messages permissions can delete outgoing messages in channels.- If the bot is an administrator of a group, it can delete any message there.- If the bot has can_delete_messages administrator right in a supergroup or a channel, it can delete any message there.- If the bot has can_manage_direct_messages administrator right in a channel, it can delete any message in the corresponding direct messages chat.Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteMessages(...$parameters) Use this method to delete multiple messages simultaneously. If some of the specified messages can't be found, they are skipped. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteEphemeralMessage(...$parameters) Use this method to delete an ephemeral message. Note that it is not guaranteed that the user will receive the message deletion event, especially if they are offline. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteMessageReaction(...$parameters) Use this method to remove a reaction from a message in a group or a supergroup chat. The bot must have the 'can_delete_messages' administrator right in the chat. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#deletemessagereaction}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target supergroup in the format @username
 * - _int_ `$message_id` __Required: Yes__. Identifier of the target message
 * - _int_ `$user_id` __Required: Optional__. Identifier of the user whose reaction will be removed, if the reaction was added by a user
 * - _int_ `$actor_chat_id` __Required: Optional__. Identifier of the chat whose reaction will be removed, if the reaction was added by a chat
 *
 *
 * @method static PromiseInterface|true deleteAllMessageReactions(...$parameters) Use this method to remove up to 10000 recent reactions in a group or a supergroup chat added by a given user or chat. The bot must have the 'can_delete_messages' administrator right in the chat. Returns True on success.
 *
 * {@see https://core.telegram.org/bots/api#deleteallmessagereactions}
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target supergroup in the format @username
 * - _int_ `$user_id` __Required: Optional__. Identifier of the user whose reactions will be removed, if the reactions were added by a user
 * - _int_ `$actor_chat_id` __Required: Optional__. Identifier of the chat whose reactions will be removed, if the reactions were added by a chat
 *
 *
 * @method static PromiseInterface|Message sendSticker(...$parameters) Use this method to send static .WEBP, animated .TGS, or video .WEBM stickers. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|StickerSet getStickerSet(...$parameters) Use this method to get a sticker set. On success, a StickerSet object is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|Sticker[] getCustomEmojiStickers(...$parameters) Use this method to get information about custom emoji stickers by their identifiers. Returns an Array of Sticker objects.
 *
 ...
 *
 *
 * @method static PromiseInterface|File uploadStickerFile(...$parameters) Use this method to upload a file with a sticker for later use in the createNewStickerSet, addStickerToSet, or replaceStickerInSet methods (the file can be used multiple times). Returns the uploaded File on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true createNewStickerSet(...$parameters) Use this method to create a new sticker set owned by a user. The bot will be able to edit the sticker set thus created. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true addStickerToSet(...$parameters) Use this method to add a new sticker to a set created by the bot. Emoji sticker sets can have up to 200 stickers. Other sticker sets can have up to 120 stickers. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setStickerPositionInSet(...$parameters) Use this method to move a sticker in a set created by the bot to a specific position. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteStickerFromSet(...$parameters) Use this method to delete a sticker from a set created by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true replaceStickerInSet(...$parameters) Use this method to replace an existing sticker in a sticker set with a new one. The method is equivalent to calling deleteStickerFromSet, then addStickerToSet, then setStickerPositionInSet. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setStickerEmojiList(...$parameters) Use this method to change the list of emoji assigned to a regular or custom emoji sticker. The sticker must belong to a sticker set created by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setStickerKeywords(...$parameters) Use this method to change search keywords assigned to a regular or custom emoji sticker. The sticker must belong to a sticker set created by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setStickerMaskPosition(...$parameters) Use this method to change the mask position of a mask sticker. The sticker must belong to a sticker set that was created by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setStickerSetTitle(...$parameters) Use this method to set the title of a created sticker set. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setStickerSetThumbnail(...$parameters) Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must match the format of the stickers in the set. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setCustomEmojiStickerSetThumbnail(...$parameters) Use this method to set the thumbnail of a custom emoji sticker set. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true deleteStickerSet(...$parameters) Use this method to delete a sticker set that was created by the bot. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendRichMessage(...$parameters) Use this method to send rich messages. If the message contains a block with a media element, then the bot must have the right to send the media to the chat. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true sendRichMessageDraft(...$parameters) Use this method to stream a partial rich message to a user while the message is being generated. Note that the streamed draft is ephemeral and acts as a temporary 30-second preview - once the output is finalized, you must call sendRichMessage with the complete message to persist it in the user's chat. Returns True on success.
 *
 ...
 * - _int_ `$message_thread_id` __Required: Optional__. Unique identifier for the target message thread
 * - _int_ `$draft_id` __Required: Yes__. Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. Otherwise, the draft is replaced without animation.
 * - _InputRichMessage_ `$rich_message` __Required: Yes__. The partial message to be streamed. Direct upload of new files and explicit upload of files by a URL isn't supported.
 * - _bool_ `$can_stop` __Required: Optional__. Pass True to show the user a button to stop further drafts. The bot will receive an Update “stopped_message_generation” if the user presses the button.
 * - _bool_ `$keep_on_stop` __Required: Optional__. Pass True to keep the draft in the chat when the button is pressed. The draft will still disappear after a short time or if the bot sends a message. To fully preserve the partial draft, the bot should send it as a new message.
 *
 *
 * @method static PromiseInterface|true answerInlineQuery(...$parameters) Use this method to send answers to an inline query. On success, True is returned.No more than 50 results per query are allowed.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendInvoice(...$parameters) Use this method to send invoices. On success, the sent Message is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|string createInvoiceLink(...$parameters) Use this method to create a link for an invoice. Returns the created invoice link as String on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true answerShippingQuery(...$parameters) If you sent an invoice requesting a shipping address and the parameter is_flexible was specified, the Bot API will send an Update with a shipping_query field to the bot. Use this method to reply to shipping queries. On success, True is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true answerPreCheckoutQuery(...$parameters) Once the user has confirmed their payment and shipping details, the Bot API sends the final confirmation in the form of an Update with the field pre_checkout_query. Use this method to respond to such pre-checkout queries. On success, True is returned. Note: The Bot API must receive an answer within 10 seconds after the pre-checkout query was sent.
 *
 ...
 *
 *
 * @method static PromiseInterface|StarAmount getMyStarBalance(...$parameters) A method to get the current Telegram Stars balance of the bot. Requires no parameters. On success, returns a StarAmount object.
 *
 * {@see https://core.telegram.org/bots/api#getmystarbalance}
 * @method static PromiseInterface|StarTransactions getStarTransactions(...$parameters) Returns the bot's Telegram Star transactions in chronological order. On success, returns a StarTransactions object.
 *
 ...
 *
 *
 * @method static PromiseInterface|true refundStarPayment(...$parameters) Refunds a successful payment in Telegram Stars. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true editUserStarSubscription(...$parameters) Allows the bot to cancel or re-enable extension of a subscription paid in Telegram Stars. Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|true setPassportDataErrors(...$parameters) Informs a user that some of the Telegram Passport elements they provided contains errors. The user will not be able to re-submit their Passport to you until the errors are fixed (the contents of the field for which you returned the error must change). Returns True on success.
 *
 ...
 *
 *
 * @method static PromiseInterface|Message sendGame(...$parameters) Use this method to send a game. On success, the sent Message is returned.
 *
 * {@see https://core.telegram.org/bots/api#sendgame}
 *
 * Parameters:
 * - _string_ `$business_connection_id` __Required: Optional__. Unique identifier of the business connection on behalf of which the message will be sent
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target bot in the format @username. Games can't be sent to channel direct messages chats and channel chats.
 * - _int_ `$message_thread_id` __Required: Optional__. Unique identifier for the target message thread (topic) of a forum; for forum supergroups and private chats of bots with forum topic mode enabled only
 ...
 *
 *
 * @method static PromiseInterface|Message|true setGameScore(...$parameters) Use this method to set the score of the specified user in a game message. On success, if the message is not an inline message, the Message is returned, otherwise True is returned. Returns an error, if the new score is not greater than the user's current score in the chat and force is False.
 *
 ...
 *
 *
 * @method static PromiseInterface|GameHighScore[] getGameHighScores(...$parameters) Use this method to get data for high score tables. Will return the score of the specified user and several of their neighbors in a game. Returns an Array of GameHighScore objects.
 *
 ...
 * - _string_ `$inline_message_id` __Required: Optional__. Required if chat_id and message_id are not specified. Identifier of the inline message.
 */
class TeleBot extends \Illuminate\Support\Facades\Facade
{
    /**
