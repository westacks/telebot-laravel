 ...
 *
 *
 * @method static PromiseInterface|Message[] sendMediaGroup(...$parameters) Use this method to send a group of photos, videos, documents or audios as an album. Documents and audio files can be only grouped in an album with messages of the same type. On success, an array of Message objects that were sent is returned.
 *
 ...
 *
 *
 * @method static PromiseInterface|true sendMessageDraft(...$parameters) Use this method to stream a partial message to a user while the message is being generated; supported only for bots with forum topic mode enabled. Returns True on success.
 *
 ...
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername). Channel direct messages chats aren't supported; leave the corresponding channel instead.
 *
 *
 ...
 *
 *
 * @method static PromiseInterface|ChatMember[] getChatAdministrators(...$parameters) Use this method to get a list of administrators in a chat, which aren't bots. Returns an Array of ChatMember objects.
 *
 ...
 *
 * Parameters:
 * - _int|string_ `$chat_id` __Required: Yes__. Unique identifier for the target chat or username of the target channel (in the format @channelusername). Channel direct messages chats can't be verified.
 * - _string_ `$custom_description` __Required: Optional__. Custom description for the verification; 0-70 characters. Must be empty if the organization isn't allowed to provide a custom verification description.
 *
 *
